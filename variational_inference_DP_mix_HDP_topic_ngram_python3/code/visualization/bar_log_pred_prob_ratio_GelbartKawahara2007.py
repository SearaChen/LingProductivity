...
def bar_log_sublex_prob_ratio(df, result_path, log_prob = 'target_log_prob', group_id_name = 'group_identifier'):
	...
	ordered_categories = ['saɾada-haɾada', 'kɯɾabɯ-naɾabɯ', 'nabi-tabi', 'medaɾɯ-kɯdaɾɯ', 'maɡɯ-toɡɯ', 'neɡa-saɡa']
...
if __name__ == '__main__':
	...
	df.loc[:,'IPA'] = df.control_word.str.replace('ä','a').str.replace('r','ɾ').str.replace('g','ɡ').str.replace(',','')
